...
<template>
  <div class="faas-login flex_r_s">
    <div class="faas-login-content flex1 flex_c_c">
      ...
      <div
        class="login-inner flex_c_c"
        :class="{ noPassClass }"
        v-if="viewType == '1'"
      >
        <div class="login-inner-head flex1">
          <div class="mt20 flex_r_c">
            <img src="../../../assets/logo_gang.jpg" style="width: 45px" />
            <span style="padding: 10px">量子防伪溯源</span>
            <span class="pr5">|</span><span>Manager</span>
          </div>
          ...
          <ui-row class="inner-row mt5">
            <ui-col :span="24">
              <ui-input
                ...
                :suffixIcon="eyeOpen ? 'openEye' : 'closeEye'"
                @click-icon="eyeOpen = !eyeOpen"
                v-model="loginParams.password"
                @keyup.enter="handleLogin('pre')"
              ></ui-input>
            </ui-col>
            ...
            <ui-col :span="24">
              <div class="inputTitle span2 mt20">
                <span
                  class="pswd_forget cur_P"
                  @click="linkTo('/resetPassWord')"
                  >忘记密码？</span
                >
              </div>
            </ui-col>
        ...
        <div class="login-inner-head flex1">
          ...
          <ui-row class="inner-row" style="margin-top: 40px">
            ...
            <ui-col :span="24">
              <ui-input
                large
                placeholder="主账号用户名或ID"
                v-model="loginChildParams.preUsername"
              ></ui-input>
            </ui-col>
          </ui-row>
          <ui-row class="inner-row mt5">
            ...
            <ui-col :span="24">
              <ui-input
                large
                placeholder="子账号用户名"
                v-model="loginChildParams.username"
              ></ui-input>
            </ui-col>
          </ui-row>
          <ui-row class="inner-row mt5">
            ...
            <ui-col :span="24">
              <ui-input
                ...
                :suffixIcon="eyeOpen ? 'openEye' : 'closeEye'"
                @click-icon="eyeOpen = !eyeOpen"
                v-model="loginChildParams.password"
              ></ui-input>
            </ui-col>
            <ui-col :span="24" v-show="noPassClass">
              <div class="errTxt span2 mt10">
          ...
          <ui-row class="inner-row mt10">
            <ui-col :span="15">
              <ui-input
                ...
                type="text"
                v-model="registerParams.checkCode"
              >
              </ui-input>
            </ui-col>
...
export default class extends Vue {
  ...
  handleLogin(type: string) {
    ...
    if (params.username == "root" && params.password == "abcd1234") {
      this.$timer.setTimeout(() => {
        this.$navbar.push({
