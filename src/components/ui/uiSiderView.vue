...
.of-drawer-head {
  ...
  @include ui-theme-border-top("border");
...
<template>
  ...
  >
    ...
    >
      <!-- inner -->
      <div class="of-drawer flex_c_c" v-on:click.stop :style="offsetInner">
        <div class="of-drawer-head flex_r_c" v-show="title.length > 0">
