  ...
  >
    <div class="store-detail-base mt20">
      <div class="detail-base-info">
        <p style="font-size: 18px; font-weight: 600">{{ $i18n('productCenter.conn.detail.基本信息') }}</p>
        <ui-row class="mt20">
          <ui-col :span="8">
            <p class="info-title">{{ $i18n('productCenter.conn.detail.名称') }}</p>
            <p>{{ app_info.name }}</p>
          </ui-col>
          <ui-col :span="8">
            <p class="info-title">{{ $i18n('productCenter.conn.detail.所属分组') }}</p>
...
export default class extends Vue {
  ...
  baseInfoTabsArr = [
    {
      name: $i18n('productCenter.conn.detail.并发量'),
      value: 1,
    },
  ];
  ...
  time_group = [
    { name: $i18n('productCenter.conn.detail.1小时'), value: 60 * 60 * 1000, choose: false },
    { name: $i18n('productCenter.conn.detail.3小时'), value: 3 * 60 * 60 * 1000, choose: false },
    { name: $i18n('productCenter.conn.detail.6小时'), value: 6 * 60 * 60 * 1000, choose: false },
    { name: $i18n('productCenter.conn.detail.12小时'), value: 12 * 60 * 60 * 1000, choose: false },
    { name: $i18n('productCenter.conn.detail.1天'), value: 24 * 60 * 60 * 1000, choose: true },
    { name: $i18n('productCenter.conn.detail.3天'), value: 3 * 24 * 60 * 60 * 1000, choose: false },
    { name: $i18n('productCenter.conn.detail.7天'), value: 7 * 24 * 60 * 60 * 1000, choose: false },
    { name: $i18n('productCenter.conn.detail.14天'), value: 14 * 24 * 60 * 60 * 1000, choose: false },
    { name: $i18n('productCenter.conn.detail.30天'), value: 30 * 24 * 60 * 60 * 1000, choose: false },
  ];
  //
  // computed.
