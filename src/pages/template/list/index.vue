  ...
  <contentView :title="'模板列表'">
    ...
    <div class="template-items">
      ...
      <template v-if="type == 'list'">
        <p class="template-item-list flex_r_s" v-for="item in 8" :key="item">
          <span>{{ item }}：item </span>
          <span class="flex1"></span>
          <button @click="linkTo('detail')">查看</button>
        </p>
      </template>
    </div>
  </contentView>
